    ...
    return(
        <header className="bg-[#ff5200] font-serif">
            ...
            <img className="h-110 w-60 absolute top-0 right-0" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/testing/seo-home/Sushi_replace.png"/>
                <div className="max-w-[65%] text-5xl text-white font-bold text-center container mx-auto">
                    Order food & groceries. Discover best restaurants. Swiggy it!
                </div>
                <div className="max-w-[65%] container mx-auto flex gap-5 mt-10">
                <input  className="bg-white w-[40%] px-2 py-4 text-xl rounded-2xl" placeholder="Delhi, India" ></input>
                <input className="bg-white w-[55%] px-2 py-4 text-xl rounded-2xl" placeholder="Search for restaurants and items for more" ></input>
